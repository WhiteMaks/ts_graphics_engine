...
class Transformation {
	 ...
	 */
	public static getPerspectiveProjectionMatrix(aspectRatio: number, fieldOfView: number, zNear: number, zFar: number): number[] {
	 ...
	 */
	public static getOrthogonalProjectionMatrix(left: number, right: number, bottom: number, top: number, near: number, far: number): number[] {
